...
\author{EdgeDecode Project\\\small Technical working draft for internal review}
...
\begin{figure}[t]
\centering\includegraphics[width=0.95\linewidth]{figures/operator.pdf}
...
\begin{table}[t]
\centering\small\input{operator-table}
...
\begin{table}[t]
\centering\small\input{search-table}
...
\begin{figure}[t]
\centering\includegraphics[width=0.95\linewidth]{figures/search.pdf}
...
\begin{figure}[t]
\centering\includegraphics[width=0.95\linewidth]{figures/architecture.pdf}
...
\begin{table}[t]
\centering\small\input{stage2-performance-table}
...
\begin{figure}[t]
\centering\includegraphics[width=0.97\linewidth]{figures/stage2-performance.pdf}
...
\begin{table}[t]
\centering\small\input{stage2-quality-table}
